...
export function EventMsg({ m, onContextMenu }: { m: Message; onContextMenu?: (event: ReactMouseEvent<HTMLDivElement>) => void }) {
  return (
    <div className="fade-up group flex flex-col items-end" onContextMenu={onContextMenu}>
...
export function NarratorMsg({
  m, settings, onChoice, onRegenerate, onBranch, isLast, onContextMenu,
}: {
  m: Message;
  settings: Settings;
  ...
  return (
    <div className="fade-up selectable" onContextMenu={onContextMenu}>
      <div
